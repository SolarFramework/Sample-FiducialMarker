...
function help()
{
    ...
    echo "It produces a zip file named '<sample name>_<version>_[release|debug].zip"
    echo
    usage
}
...
function usage()
{
    ...
    echo "   -v, --version: sample version (default: $VERSION)"
    echo "   -n, --name: sample name (default: $NAME)"
}
