...
TARGET = SolARPipeline_FiducialMarker_Runner
VERSION=0.9.1
...
SOURCES += \
    src/main.cpp\
    src/SolARPipelineFiducialMarkerRunner.cpp
...
config_files.files= $$files($${PWD}/SolARPipeline_FiducialMarker_Runner_conf.xml)\
...
OTHER_FILES += \
    ...
    SolARPipeline_FiducialMarker_Runner_conf.xml
